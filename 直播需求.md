...
ALTER TABLE hn_basketball_schedule ADD COLUMN follow INT(11) DEFAULT 0 COMMENT '关注人数';

hn_basketball_schedule 表
1. 主队客队相关字段去掉team
2. leagueChs、leagueCht 改为 leagueChsShort、leagueChtShort
hn_basketball_leagues 表
1. logo 改为 leagueLogo
```
