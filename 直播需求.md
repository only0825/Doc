...
##### 二、{sign_key}&urlencode{query_string} 的到property

```java
fnKSNAapCwVXfhTM&conv_time%3D1668770060413%26client_ip%3D127.0.0.1%26ua%3DMozilla%2F5.0+%28Macintosh%3B+Intel+Mac+OS+X+10_15_7%29+AppleWebKit%2F537.36+%28KHTML%2C+like+Gecko%29+Chrome%2F107.0.0.0+Safari%2F537.36
```

##### 三、signature： md5(property)

```java
613ce6ccf94304a5235e826cd66fb52b
```

```php
http://trail.e.mi.com/global/test?appId=1521893&info=&conv_type=APP_ACTIVE&customer_id=354002
```
...
* 激活
  * 秘钥A(encrypt_key): opOlZpoAJcBtEPvP
...
```
        ...
        $finalUrl = Report::index($header, "APP_ACTIVE", $this->getIp());
